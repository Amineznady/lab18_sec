Java.perform(function() {
    ...
    MainActivity.generateRandomString.implementation = function (input) {

        console.log("🔥 INPUT (sb) = " + input);

        var result = this.generateRandomString(input);

        console.log("💣 OUTPUT (PASSWORD FINAL) = " + result);
